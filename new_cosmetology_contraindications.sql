...
CREATE TABLE `contraindications` (
  ...
  `conName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`IDcon`)
...
INSERT INTO `contraindications` VALUES (1,'Сахарный диабет'),(2,'Беременность и лактация');
